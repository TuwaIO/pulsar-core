...
Defined in: [packages/pulsar-core/src/store/initializeTxTrackingStore.ts:78](https://github.com/TuwaIO/pulsar-core/blob/3307a45a24b5cbed98dc52a5d0d9d419fa72f5c9/packages/pulsar-core/src/store/initializeTxTrackingStore.ts#L78)
