...
Defined in: [packages/pulsar-core/src/store/transactionsSelectors.ts:65](https://github.com/TuwaIO/pulsar-core/blob/3ba2d01231ada5db5bd141e51fda8a3427ad1f9d/packages/pulsar-core/src/store/transactionsSelectors.ts#L65)
