...
**Pulsar** transforms transaction tracking from a complex technical challenge into a simple, elegant integration. We provide the headless "brain" and the UI "body" to deliver a seamless, professional transaction experience with just a few lines of code.
...
└───────────────────┬───────────────────────┘
                    │ (Plugs into Core)
┌───────────────────▼───────────────────────┐
│         @tuwaio/pulsar-evm (Adapter)      │
│  • EVM-specific logic (viem/wagmi)        │
│  • Trackers: Standard, Safe, Gelato       │
└───────────────────┬───────────────────────┘
                    │ (The Core Engine)
┌───────────────────▼───────────────────────┐
│          @tuwaio/pulsar-core              │
...
### ✨ Key Features
  ...
  - **⛓️ Multi-Chain & Multi-Tracker:** Comes with a powerful EVM adapter that supports standard transactions, Safe multi-sigs, and Gelato meta-transactions out-of-the-box.
